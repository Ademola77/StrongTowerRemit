...
extern void *mono_aot_module_StrongTowerRemit_Model_info;
extern void *mono_aot_module_StrongTowerRemit_info;
...
void register_aot_modules ()
{
	...
	mono_aot_register_module (mono_aot_module_StrongTowerRemit_Model_info);
	mono_aot_register_module (mono_aot_module_StrongTowerRemit_info);
